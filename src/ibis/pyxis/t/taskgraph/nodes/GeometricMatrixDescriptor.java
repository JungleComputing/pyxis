...
public class GeometricMatrixDescriptor<Type> extends OperationDescriptor<Type> {
     ...
     */
    public GeometricMatrixDescriptor(PyxisTContext context, int opcode, double alpha,
            boolean linearInterpolation, boolean resize, Pixel<Type> background, ActivityIdentifier parent) {
